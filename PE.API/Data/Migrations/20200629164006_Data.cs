    ...
    public partial class Data : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RefreshTokensDto", x => x.Token);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RostersDto", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRosterAccessesDto", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainSpecialization = table.Column<string>(nullable: true),
                    OffSpecialization = table.Column<string>(nullable: true),
                    Role = table.Column<string>(nullable: true),
                    Points = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RaidersDto", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    RaiderId = table.Column<string>(nullable: true),
                    Message = table.Column<string>(nullable: true),
                    CreatorId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RaiderNotesDto", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RefreshTokensDto_UserId",
                table: "RefreshTokensDto",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_RostersDto_CreatorId",
                table: "RostersDto",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_UserRosterAccessesDto_CreatorId",
